# A simple junit test showing how to use odiem. #
...
public class OdiemTest implements OdmConnectionListener {
	...
	public static void setUp() {
		try {
			...
			//PropertyEditorManager.setEditorSearchPath(new String[]{"sun.beans.editors","org.odiem.test.editors"});
	...
	public void testAdd() {
		try {
			...
			person1.setTelephoneNumber(new SimplePhone("06","111"), new SimplePhone("02","222"));
			person1.setBasedn("ou=test,dc=cab");

			OdmFriend friend = new OdmFriend();
			friend.setCommonName("imAFriend");
			friend.setSurname("hei");
			friend.setTelephoneNumber(new SimplePhone("06","333"), new SimplePhone("02","444"));
			...
			person2.setTelephoneNumber(new SimplePhone("06","555"), new SimplePhone("02","666"));
